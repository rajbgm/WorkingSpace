...
},{"../services/settingSaveService":26}],10:[function(require,module,exports){
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.home',
    [
        'ui.router',
        'ui.bootstrap',
        'cgNotify',
        ...
        'ngSanitize',
        'textAngular',
        require('../utils/interceptor.js').name,
        require('../shared/groupSearch/groupSearchController').name,
        require('../shared/removeHTMLTags').name,
        require('./group/groupController').name,
        require('./breadCrumb/breadCrumbController').name,
        require('../settings/group/groupCreateController').name,
        require('../settings/export/exportController').name
    ]
).config(
    [
        ...
        function ($stateProvider, $urlRouterProvider, $httpProvider) {
            ...
            $urlRouterProvider.otherwise('accountsetting');
            $stateProvider.state('settingIndex', {
                url: '/accountsetting',
                templateUrl: 'partials/sharedViews/groupSearch.html'
            }).
                state('setting', {
                    url: '/setting/{menuName}',
                    templateUrl: 'partials/settings/setting.html'
                }).
                state('childgroup', {
                    url: '/childgroup',
                    templateUrl: 'partials/settings/createGroup.html'
                }).
                state('fileimport', {
                    url: '/fileimport',
                    templateUrl: 'partials/settings/importExport.html'
                }).
                state('settingIndex.html', {
                    url: '/accountsetting',
                    templateUrl: 'settingIndex.html'
                }).
                state('search', {
                    url: '/search',
                    templateUrl: 'partials/sharedViews/groupSearch.html'
...
},{"../settings/export/exportController":14,"../settings/group/groupCreateController":20,"../shared/groupSearch/groupSearchController":28,"../shared/removeHTMLTags":32,"../utils/interceptor.js":39,"./breadCrumb/breadCrumbController":12,"./group/groupController":19}],11:[function(require,module,exports){
/**
...
},{"../../shared/lookupService":30,"../services/settingSaveService":26}],12:[function(require,module,exports){
/*** Created by PraveenP on 4/26/2016.*/
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.BreadCrumbController',
    [
        require('./breadCrumbService').name
    ]
).controller('BreadCrumbController',
    [
        '$scope', 'breadCrumbService', '$state',
        function ($scope, breadCrumbService, $state) {
            var self = this;
            $scope.group.breadCrumb = [];
            ...
            self.getBreadCrumb = function () {
                if($scope.group.groupId) {
                    breadCrumbService.getBreadCrumbData($scope.group.groupId).then(function (response) {
...
module.exports = angular.module(
    'onlife.admin.settings.breadCrumbService',
    [
        ...
        function (restfulRepo) {
            return {
                getBreadCrumbData: function (parentGroupId) {
                    ...
                    return restfulRepo.getBreadCrumbMethod(apiEndPoint);
                }
...
},{"../../shared/restfulRepo":33}],14:[function(require,module,exports){
/*** Created by PraveenP on 4/22/2016.*/
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.ExportController',
    [
        require('./exportService').name
    ]
    ...
    [
        ...
        function ($scope, exportService) {
            ...
            self.export = {
                ...
                isFlattenedSettings: false
            };

            self.exportSetting = function () {
                exportService.importSetting($scope.group.groupId, self.export);
            };
        }
    ]
);

},{"./exportService":15}],15:[function(require,module,exports){
/*** Created by PraveenP on 4/22/2016.*/
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.exportService',
    [
    ]
    ...
    [
        function () {
            return {
                ...
                importSetting: function (groupId, exportObj) {
                    var apiEndPoint = baseURL + '/admin/exportsettings/'
                        + groupId + '/' + exportObj.isChildRequired + '/' + exportObj.isFlattenedSettings;
...
},{"./settingService":18}],17:[function(require,module,exports){
'use strict';
        ...
        function ($scope, settingService, $location, primaryModal, settingSaveService, lookupService) {
            ...
            self.constructSettingGrid = function (data, settingName) {
                ...
                var settings = {
                    ...
                    Incentives: function () {
                        self.manageIncentiveData = data.data;
                        lookupService.getLookupData('precondition').then(function (data) {
                            self.lookupData.preConditionList = data.data;
                        });
                        lookupService.getLookupData('pointsfrequency').then(function (data) {
                        ...
                        lookupService.getLookupData('actioncategory').then(function (response) {
                            self.lookupData.actionCategory = response.data;
                            _.forEach(self.manageIncentiveData, function (pointsData) {
                                _.find(self.lookupData.actionCategory, function (actionData) {
                                    if(actionData.Id === pointsData.ActionCategoryID) {
                                        pointsData.ActionDisplayName = actionData.Value;
                                    }
            ...
            /* Points Matrix*/
            self.createEditIncentives = function (pointMatrixData, pointsMatrixIndex, isEditMode) {
                var primaryModalParam = {
                    template: 'partials/settings/manageIncentives.html',
                    controller: 'PointsMatrixController as pointsMatrixCtrl',
                    modelParam: self.modelParam('Manage Incentive', pointMatrixData, pointsMatrixIndex, isEditMode),
                    size: 'lg'
                };
                primaryModal.launchPrimaryModal(primaryModalParam);
            };
            ...
            self.filterCurrentSettings = function (showCurrentSetting, settingName) {
                var settings = {
                    ...
                    Incentives: function () {
                        self.manageIncentiveData = self.customFilter(showCurrentSetting, self.manageIncentiveData);
                    }
                };
                return settings[settingName]();
            };
...
},{"../../shared/lookupService":30,"../../shared/primaryModal":31,"../announcements/announcementController":9,"../authenticationFields/authenticationFieldController":11,"../introScreens/introScreenController":22,"../marketingTiles/marketingTileController":23,"../myCompany/myCompanyController":24,"../pointsMatrix/pointsMatrixController":25,"../services/settingSaveService":26,"./settingHistoryController":16,"./settingService":18}],18:[function(require,module,exports){
'use strict';
        ...
        function (restfulRepo) {
            return {
                ...
                getSettingMenu: function () {
                    ...
                    return restfulRepo.getMenuMethod(apiEndPoint);
                },
                ...
                getSettingData: function (settingName) {
                    if(settingName === 'Announcements')
                    {
                        return restfulRepo.getAnnouncementMethod();
                    }
                    if(settingName === 'MarketingTiles')
                    {
                        return restfulRepo.getMarketingMethod();
                    }
                    if(settingName === 'PointsMatrix')
                    {
                        return restfulRepo.getPointsMethod();
                    }
                    if(settingName === 'Incentives')
                    {
                        return restfulRepo.getIncentiveMethod();
                    }
...
},{"../../shared/restfulRepo":33}],19:[function(require,module,exports){
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.GroupController',
    [
         require('../../shared/groupSearch/groupService').name,
         require('../../shared/fileImport').name,
         require('../groupSetting/settingService').name,
        require('../../shared/lookupService').name
    ]
).controller('GroupController',
    [
        '$scope','groupService','settingService', '$location','lookupService','$timeout',
        function ($scope, groupService, settingService, $location, lookupService, $timeout) {
            var self = this;
            self.groupData = [];
            self.settingMenu = [];
            self.menuClass = [];
            ...
            self.getGroupData = function () {
                groupService.getGroupData().then(function (data) {
                    ...
                    self.getSettingMenu(self.groupData.Id);
                });
                lookupService.getLookupData('languages').then(function (data) {
            ...
            self.createSubGroup = function () {
                $location.path('/childgroup');
            };

            self.fileUpload = function () {
                $location.path('/fileimport');
            };

            self.clearSettingCache = function () {
                settingService.clearSettingCache();
            };

            $scope.$on('date_picker', function ($event) {
                $event.preventDefault();
                $event.stopPropagation();
            });
...
},{"../../shared/fileImport":27,"../../shared/groupSearch/groupService":29,"../../shared/lookupService":30,"../groupSetting/settingService":18}],20:[function(require,module,exports){
/*** Created by PraveenP on 4/20/2016.*/
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.GroupCreateController',
    [
        require('./groupCreateService').name
    ]
).controller('GroupCreateController',
    [
        '$scope','groupCreateService','notify',
        function ($scope, groupCreateService, notify) {
            var self = this;
            self.groupData={};

            self.createGroup = function () {
                self.groupData.ParentGroupID = $scope.group.groupId;
                groupCreateService.createGroup(self.groupData).then(function (data) {
                    if(data.status === 200) {
                        notify({ message: 'Group Created',
                            classes: 'alert-success', templateUrl: 'partials/settingNotification.html'});
                    }
                    else {
                        notify({ message: 'Oops!!',
                            classes: 'alert-danger', templateUrl: 'partials/settingNotification.html'});
                    }
                    self.groupData={};
                });
            };
...
},{"./groupCreateService":21}],21:[function(require,module,exports){
/**
 * Created by PraveenP on 6/17/2016.
 */
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.groupCreateService',
    [
        require('../../shared/restfulRepo').name
    ]
).service('groupCreateService',
    [
        'restfulRepo',
        function (restfulRepo) {
            return {
                createGroup: function (groupData) {
                    var apiEndPoint = '/admin/Create';
                    return restfulRepo.postMethod(groupData, apiEndPoint);
                }
            };
        }
    ]
...
},{"../../shared/restfulRepo":33}],22:[function(require,module,exports){
/**
...
},{"../services/settingSaveService":26}],23:[function(require,module,exports){
/**
...
},{"../services/settingSaveService":26}],24:[function(require,module,exports){
/**
...
},{"../services/settingSaveService":26}],25:[function(require,module,exports){
...
},{"../../shared/lookupService":30,"../services/settingSaveService":26}],26:[function(require,module,exports){
/**
...
},{"../../shared/restfulRepo":33}],27:[function(require,module,exports){
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.fileImport',
    [

    ]
).directive('fileImport',
    [ 'notify',
       function(notify) {
           return {
               restrict: 'EA',
               link: function(scope, el, attrs) {
                   el.dropzone({
                       url: baseURL + '/admin/importSettings',
                       ...
                       init: function() {
                           ...
                           this.on('failure', function(file, json) {
                               notify({ message: json,
                                   classes: 'alert-danger', templateUrl: 'partials/settingNotification.html'});
                           });
                       }
...
},{"../../settings/groupSetting/settingListController":17,"../../userCreationTool/creationController.js":34,"../../userCreationTool/testUsersController.js":37,"./groupService":29}],29:[function(require,module,exports){
'use strict';
...
},{"../../shared/restfulRepo":33}],30:[function(require,module,exports){
/**
        ...
        function (restfulRepo) {
            return {
                getLookupData: function (name) {
                    ...
                    {
                        return restfulRepo.getPreconditionMethod();
                    }
                    if(name === 'pointsfrequency')
                    {
                        return restfulRepo.getPointsfrequencyMethod();
                    }
                    if(name === 'actioncategory')
                    {
                        return restfulRepo.getActioncategoryMethod();
                    }
                    if(name === 'languages')
                    {
                        return restfulRepo.getLanguages();
                    }
...
},{"./restfulRepo":33}],31:[function(require,module,exports){
/**
 * Created by PraveenP on 5/27/2016.
 */
'use strict';
...
/**
 * Created by PraveenP on 9/15/2016.
 */
'use strict';

module.exports = angular.module(
    'onlife.admin.settings.removeHTMLTags',
    [
...
module.exports = angular.module(
    ...
    [
        ...
        self.getDummyMethod = function (apiEndPoint) {
           return $http.get('GroupSearch.json');
        };

        self.getBreadCrumbMethod = function (apiEndPoint) {
            return $http.get('BreadCrumb.json');
        };

        self.getGroupMethod = function (apiEndPoint) {
            return $http.get('Group.json');
        };

        self.getMenuMethod = function (apiEndPoint) {
            return $http.get('LeftMenu.json');
        };

        self.getAnnouncementMethod = function (apiEndPoint) {
            return $http.get('Announcement.json');
        };

        self.getMarketingMethod = function (apiEndPoint) {
            return $http.get('MarketingTile.json');
        };

        self.getPointsMethod = function (apiEndPoint) {
            return $http.get('PointsMatrix.json');
        };

        self.getIncentiveMethod = function (apiEndPoint) {
            return $http.get('ManageIncentive.json');
        };

        self.getPreconditionMethod = function (apiEndPoint) {
            return $http.get('PreconditionLookup.json');
        };

        self.getPointsfrequencyMethod = function (apiEndPoint) {
            return $http.get('PointsfrequencyLookup.json');
        };

        self.getActioncategoryMethod = function (apiEndPoint) {
            return $http.get('ActioncategoryLookup.json');
        };

        self.getLanguages = function (apiEndPoint) {
...
},{"./creationService.js":35,"./initializeFormService.js":36,"json2csv":3}],35:[function(require,module,exports){
...
},{"../shared/restfulRepo":33}],36:[function(require,module,exports){
/** Created by Reed McLean and Kendall Haberer 6/22/2016 **/
'use strict';
...
},{"../shared/primaryModal":31,"./testUsersService.js":38}],38:[function(require,module,exports){
...
},{"../shared/restfulRepo":33}],39:[function(require,module,exports){
/*** Created by PraveenP on 6/1/2016.*/
'use strict';

module.exports = angular.module(
    'onlife.admin.utils.interceptor',
    [
        require('./loggingService').name
    ]
).factory('interceptor',
    [
        '$q',
...
},{"./loggingService":40}],40:[function(require,module,exports){
/**
 * Created by PraveenP on 6/1/2016.
 */
'use strict';
...
module.exports = angular.module(
    'onlife.admin.utils.loggingService',
    [
        ...
        function (notify) {
            return {
                viewSetting: function () {
                    notify({ message: 'The Setting Is Saved',
                        classes: 'alert-success',
                        template:[ '<div class="cg-notify-message inspinia-notify" ng-class="$classes">',
                                  ' <div class="p-lg"> <div ng-show="!$messageTemplate">{{$message}}</div>',
                                 '<div ng-show="$messageTemplate" class="cg-notify-message-template"></div>',
                                '<button type="button" class="cg-notify-close" ng-click="$close()">',
                                ' <span aria-hidden="true">&times;</span>',
                                '<span class="cg-notify-sr-only">Close</span></button></div></div>']});
                }
            };
        }
    ]
